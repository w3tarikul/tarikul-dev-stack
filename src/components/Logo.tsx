...
function Logo({ variant = 'header' }: LogoProps) {
  ...
  return (
    <a href="#" className="flex items-center gap-1.5 sm:gap-2.5">
      <span className="flex size-7 items-center justify-center rounded-md bg-linear-to-tr from-pink-500 to-violet-600 text-[10px] font-extrabold tracking-[-0.5px] text-white shadow-xs sm:size-8 sm:rounded-lg sm:text-sm">
        DS
      </span>
      <span className="font-inter text-[13px] font-bold tracking-[-0.5px] text-gray-900 sm:font-sans sm:text-xl sm:leading-7 sm:tracking-[-0.5px] sm:text-slate-900">
        Dev
